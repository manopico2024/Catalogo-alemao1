...
class Ui_root(object):
    def setupUi(self, root):
        ...
        self.button_adicionar.setAutoFillBackground(True)
        ...
        self.label.setGeometry(QtCore.QRect(8, 180, 56, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.label.setFont(font)
        self.label.setStyleSheet("background-color: rgb(219, 219, 219);\n""border:1px solid black;")
        ...
        self.label_2.setGeometry(QtCore.QRect(7, 60, 103, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
